...
/// special ones:
///
/// * OP_UNIMP - means that this instruction is legal, but has not been
///              implemented in the simulator yet.
/// * OP_RES - means that this is a reserved opcode (it is not supported by
///            the architecture).
